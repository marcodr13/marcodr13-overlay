...
if [[ ${PV} == *9999* ]]; then
	...
	SRC_URI="https://electroncash.org/downloads/${PV}/win-linux/${MY_P}.tar.gz"
...
LICENSE="MIT"
SLOT="0"
IUSE="audio_modem cli cosign digitalbitbox email greenaddress_it ncurses qrcode +qt4 sync vkb"
